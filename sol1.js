 ...
 var see = cal+sen
   ...
   bot.telegram.sendMessage(pData[0].inviter, '➕ *New Referral on your link* you received '+ref_bonus+' '+bot_cur, {parse_mode:'markdown'})
    ...
    ctx.replyWithMarkdown(
      '[🏠 Main Menu](https://twitter.com/tnvillanyt1)',
...
var opt = {
  key:'e9d8e3274ab9db07fe84809ae22b0356668e1977aa54a8f1a769069aaddad6e1', 
  secret:'c71020C088797c2A228ae90bbb90CBfe317767d6582bed53D50bce8BA57a3201'
  }
...
console.log(cptid)
// console.log(txxid)/
let paychannel = "@TNG_TO_MOON"; //add payout channel here
